...
# Problem 3b - Fitting a CIR model to the yield curve
...
# Problem 4 - Fitting a Hull-White Extended Vasicek model to the data
...
# Problem 6 - Simulation in the Hull-White Extended Vasicek model
...
r_simul = fid.simul_hwev(f_simul[0],t_simul,theta,a,sigma,method = "euler")
...
# # Problem 7 - Pricing a 1Y10Y receiver swaption
strike = 0.06
...
# # Problem 7 - Pricing a digital option
strike = 0.06
T_n, T_N, alpha = 1, 11, 0.5
...
# # fig.savefig("C:/Jacob/Uni_of_CPH/FID/FID_E2024/Examples/hwev_zcb_curve_fit.pdf")
# # plt.show()
...
# fig.savefig("C:/Jacob/Uni_of_CPH/FID/FID_E2024/Examples/hwev_zcb_fit_vasicek_fit.pdf")
# plt.show()
...
p1 = ax.scatter(T_inter, R_inter, s = 1, color = 'black', marker = ".",label="ZCB Spot rates")
p2 = ax.scatter(T_inter, f_inter, s = 1, color = 'red', marker = ".",label="ZCB forward rates")
p3 = ax.scatter(T_inter, R_cir, s = 1, color = 'blue', marker = ".",label="CIR Spot rates")
p4 = ax.scatter(T_inter, f_cir, s = 1, color = 'orange', marker = ".",label="CIR forward rates")
plots = [p1,p2,p3,p4]
labels = [item.get_label() for item in plots]
ax.legend(plots,labels,loc="lower right",fontsize = 5)
# fig.savefig("C:/Jacob/Uni_of_CPH/FID/FID_E2024/Examples/hwev_zcb_fit_cir_fit.pdf")
# plt.show()
...
# labels = [item.get_label() for item in plots]
# ax.legend(plots,labels,loc="upper right",fontsize = 5)
# # fig.savefig("C:/Jacob/Uni_of_CPH/FID/FID_E2024/Examples/hwev_f_star.pdf")
# plt.show()
#
...
p4 = ax.scatter(t_simul, mean_hwev, s = 1, color = 'green', marker = ".",label=f"Mean")
p5 = ax.scatter(t_simul, theta, s = 1, color = 'orange', marker = ".",label=f"Theta")
p1 = ax.scatter(t_simul, r_simul, s = 1, color = 'red', marker = ".",label="Euler")
plots = [p2,p3,p4,p5]
labels = [item.get_label() for item in plots]
ax.legend(plots,labels,loc="upper right",fontsize = 5)
# fig.savefig("C:/Jacob/Uni_of_CPH/FID/FID_E2024/Examples/hwev_f_star.pdf")
